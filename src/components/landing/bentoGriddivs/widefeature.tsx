...
export const WideFeatureCard = () => {
    return (
        <MotionCard className="sm:w-2/3 w-full h-44 p-0 bg-transparent relative text-left">
            ...
            <div className="bg-foreground/30 z-10 backdrop-blur-2xl w-full h-full flex flex-col justify-center items-center">
                <h1 className=" text-3xl ">Make Banger <br /> <span className="font-dotted text-primary">Instagram</span> Carousels</h1>
            </div>
        </MotionCard>
    )
}